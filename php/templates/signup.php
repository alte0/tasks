<form class="form form_center form_reg" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
  ...
  <div class="form__row form__row_content-column">
    ...
    <?= !empty($errorsForm["password2"]) ? "<div class=\"error\"><p class=\"error__text\">{$errorsForm["password2"]}</p></div>" : "" ?>
  </div>
  <div class="form__row form__row_content-column">
    ...
    <?= !empty($errorsForm["name"]) ? "<div class=\"error\"><p class=\"error__text\">{$errorsForm["name"]}</p></div>" : "" ?>
  </div>
  <div class="form__row form__row_content-column">
    ...
    <?= !empty($errorsForm["surname"]) ? "<div class=\"error\"><p class=\"error__text\">{$errorsForm["surname"]}</p></div>" : "" ?>
  </div>
  <div class="form__row form__row_content-column">
    ...
    <?= !empty($errorsForm["patronymic"]) ? "<div class=\"error\"><p class=\"error__text\">{$errorsForm["patronymic"]}</p></div>" : "" ?>
  </div>
  <div class="form__row form__row_content-column">
