<form class="form form_reg" action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
  ...
  <div class="form__row form__row_content-column">
    <label for="name">Имя:</label><input class="form__input" id="name" type="text" name="name" minlength="2" maxlength="20" required="required" />
  </div>
  <div class="form__row form__row_content-column">
    <label for="surname">Фамилия:</label><input class="form__input" id="surname" type="text" name="surname" minlength="2" maxlength="20" required="required" />
  </div>
  <div class="form__row form__row_content-column">
    <label for="patronymic">Отчество:</label><input class="form__input" id="patronymic" type="text" name="patronymic" minlength="2" maxlength="20" required="required" />
  </div>
  <div class="form__row form__row_content-column">
