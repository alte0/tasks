<div class="tasks__add-task">
  <form class="form form_task-add" action="/add-task.php" method="post">
    <div class="form__row form__row_label-group-two">
      ...
      <div class="flatpickr">
        <input id="date" class="form__date" type="text" name="date" placeholder="выберите дату или даты" data-input="data-input" required="required" value="<?= isset($_POST["date"]) ? getPostVal("date") : $today  ?>" />
