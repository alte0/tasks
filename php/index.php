...
$tasks = getMyTasks($linkDB, $isClosedModeTasks ? $sqlMyTasksComplete : $sqlMyTasks, $userId);
...
$sqlOffset = ($isClosedModeTasks ? $sqlMyTasksComplete : $sqlMyTasks) . " LIMIT " . $pageItems . ' OFFSET ' . $offset;
